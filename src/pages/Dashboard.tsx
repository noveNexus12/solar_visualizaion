...
export default function Dashboard() {
  const [stats, setStats] = useState<Stats>({ total: 0, active: 0, inactive: 0, alerts: 0 });
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Monitor your solar street lamp network in real-time</p>
      </div>
